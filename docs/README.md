...
component boundary, canonical storage, control-plane, Sentry compatibility,
and ingestion contracts. Additional contracts should be cataloged here when
their owning project or domain is introduced.
...
- `docs/servers-watchtower-ingestion-contract.md`
