...
- Creation, deletion, and rotation require an idempotency key scoped by principal, organization, and operation. Reusing a key with different content is a conflict.
